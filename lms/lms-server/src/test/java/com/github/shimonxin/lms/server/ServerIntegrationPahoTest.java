...
public class ServerIntegrationPahoTest {
	...
	/**
	 * Check that after a client has connected with clean session false, subscribed to some topic and exited, if it reconnect with clean session true, the
	 * m_server correctly cleanup every previous subscription
	 */
	@Test
